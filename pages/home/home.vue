<template>
	<view class="page">
		<view class="head-info">
			<!-- 搜索 -->
			<view class="head-search" :style={paddingTop:paddingTop}>
		...
		<view class="main">
			<!-- banner -->
			<view class="banner" v-show="swiperList.length > 0">
...
<script>
	...
	export default {
		...
		onReady() {
			...
			const barHeight = uni.getMenuButtonBoundingClientRect();
			this.paddingTop = statusHeight + 'px';
			// #endif
		},
		onLoad() {
